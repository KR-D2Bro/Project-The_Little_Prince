...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(21 + 1000, new string[] { "어린왕자: 여기 유리병이야","장미:고마워.. 그런데 좀 더 빨리 해줄순 없었어?", "어린왕자: ...(예쁘지만 너무 까탈스럽네..)","난 이제 다른 곳으로 떠날 때가 된 것 같아. 잘 있어." , "장미: ...",
        "어린왕자: ...잘 지내.","장미: 그렇게 우물쭈물하지 마, 신경질 나게. 떠나려면 빨리 떠나.","포탈을 사용하여 떠나자"});
